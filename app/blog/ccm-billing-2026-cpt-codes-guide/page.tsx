  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "CCM Billing in 2026: The Complete Guide to CPT 99490, 99439, 99487, and 99489", "item": "https://www.positivecheck.com/blog/ccm-billing-2026-cpt-codes-guide" }
            ]
          })
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "The complete 2026 guide to Chronic Care Management billing: CPT 99490, 99439, 99487, and 99489 rates, non-complex vs. complex CCM, audit-defensible documentation, and the CY 2026 Physician Fee Schedule changes.",
            "image": "https://www.positivecheck.com/images/ccm-billing-2026-guide.png",
      ...
      <main className="container mx-auto px-4 py-8">
        <CcmBilling2026CptCodesGuidePost />
      </main>
      <PublicFooter />
    </div>
  )
