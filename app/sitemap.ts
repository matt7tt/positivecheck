...
const entries: Entry[] = [
  ...
  { path: "/about/clinical-standards", lastmod: "2026-07-12", changefreq: "monthly", priority: 0.8,
  ...
  { path: "/faq", lastmod: "2026-07-12", changefreq: "monthly", priority: 0.7,
    images: ["/images/admin-console-dashboard-new.png"] },
  { path: "/solutions/remote-patient-monitoring", lastmod: "2026-05-17", changefreq: "monthly", priority: 0.9,
    images: ["/images/admin-console-dashboard-new.png"] },
  ...
  { path: "/solutions/post-discharge-follow-up/faq", lastmod: "2026-09-13", changefreq: "monthly", priority: 0.8,
    images: ["/images/admin-console-dashboard-new.png"] },
  { path: "/solutions/post-discharge-follow-up/cpt-99495-billing-guide", lastmod: "2026-09-13", changefreq: "monthly", priority: 0.8,
    images: ["/images/admin-console-dashboard-new.png"] },
  { path: "/solutions/post-discharge-follow-up/30-day-readmission-reduction", lastmod: "2026-09-03", changefreq: "monthly", priority: 0.8,
    images: ["/images/admin-console-dashboard-new.png"] },
  { path: "/solutions/post-discharge-follow-up/post-discharge-contact-timing", lastmod: "2026-09-13", changefreq: "monthly", priority: 0.8,
    images: ["/images/admin-console-dashboard-new.png"] },
  { path: "/solutions/post-discharge-follow-up/vs-manual-discharge-outreach", lastmod: "2026-09-13", changefreq: "monthly", priority: 0.8,
    images: ["/images/admin-console-dashboard-new.png"] },
  ...
  { path: "/resources/glossary/cpt-99445", lastmod: "2026-05-17", changefreq: "monthly", priority: 0.7 },
  { path: "/resources/glossary/cpt-99470", lastmod: "2026-05-17", changefreq: "monthly", priority: 0.7 },
  ...
  { path: "/resources/compare/rpm-vs-ccm-medicare-billing", lastmod: "2026-05-18", changefreq: "monthly", priority: 0.8 },
  { path: "/resources/compare/tcm-and-ccm-combined-month-billing", lastmod: "2026-09-13", changefreq: "monthly", priority: 0.8 },
  { path: "/resources/billing-guide", lastmod: "2026-09-03", changefreq: "monthly", priority: 0.9 },
];
