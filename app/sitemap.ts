...
const entries: Entry[] = [
  ...
  { path: "/blog/ccm-billing-2026-cpt-codes-guide", lastmod: "2026-07-02", changefreq: "monthly", priority: 0.7,
  ...
  { path: "/solutions/post-discharge-follow-up/faq", lastmod: "2026-04-19", changefreq: "monthly", priority: 0.8,
    images: ["/images/admin-console-dashboard-new.png"] },
  { path: "/solutions/post-discharge-follow-up/cpt-99495-billing-guide", lastmod: "2026-09-03", changefreq: "monthly", priority: 0.8,
    images: ["/images/admin-console-dashboard-new.png"] },
  { path: "/solutions/post-discharge-follow-up/30-day-readmission-reduction", lastmod: "2026-09-03", changefreq: "monthly", priority: 0.8,
    images: ["/images/admin-console-dashboard-new.png"] },
  { path: "/solutions/post-discharge-follow-up/post-discharge-contact-timing", lastmod: "2026-09-03", changefreq: "monthly", priority: 0.8,
    images: ["/images/admin-console-dashboard-new.png"] },
  ...
  { path: "/resources/compare/tcm-and-ccm-combined-month-billing", lastmod: "2026-09-03", changefreq: "monthly", priority: 0.8 },
