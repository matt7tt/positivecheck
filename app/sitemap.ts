...
const entries: Entry[] = [
  ...
  { path: "/solutions/post-discharge-follow-up/faq", lastmod: "2026-04-19", changefreq: "monthly", priority: 0.8,
    images: ["/images/admin-console-dashboard-new.png"] },
  { path: "/solutions/post-discharge-follow-up/cpt-99495-billing-guide", lastmod: "2026-08-23", changefreq: "monthly", priority: 0.8,
    images: ["/images/admin-console-dashboard-new.png"] },
  { path: "/solutions/post-discharge-follow-up/30-day-readmission-reduction", lastmod: "2026-08-23", changefreq: "monthly", priority: 0.8,
    images: ["/images/admin-console-dashboard-new.png"] },
  { path: "/solutions/post-discharge-follow-up/post-discharge-contact-timing", lastmod: "2026-08-23", changefreq: "monthly", priority: 0.8,
    images: ["/images/admin-console-dashboard-new.png"] },
  ...
  { path: "/resources/compare/tcm-and-ccm-combined-month-billing", lastmod: "2026-08-23", changefreq: "monthly", priority: 0.8 },
  { path: "/resources/billing-guide", lastmod: "2026-05-18", changefreq: "monthly", priority: 0.9 },
];
