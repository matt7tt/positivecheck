...
import { StructuredData, organizationSchema, productSchemaFamilies, faqSchema } from "@/components/structured-data"
...
export default function FamiliesPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <StructuredData data={productSchemaFamilies} />
          ...
          <div className="flex items-center space-x-2">
            <Link href="/" className="flex items-center">
              <img
                ...
                alt="Positive Check - Daily wellness monitoring for aging parents"
      ...
      <section className="px-6 py-16 bg-white">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <img
              src="/images/happy-senior-talking-to-lola.webp"
              alt="Senior woman enjoying daily wellness call with AI companion Lola"
      ...
      <section className="px-6 py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="relative order-2 lg:order-1">
            <img
              src="/images/concerned-man-wellness-alerts.webp"
              alt="Adult son checking on elderly parent's wellness through Positive Check app"
              className="rounded-lg shadow-xl w-full h-80 object-cover"
            />
          </div>
