        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-700">
                Automate routine engagement so care teams can focus on higher-value clinical interactions.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-6 py-16 bg-gradient-to-br from-[#e879f9] to-[#d946ef] text-white">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-xl mb-8 text-purple-100 leading-relaxed">
            Positive Check is a trusted partner for providers building scalable, reimbursement-aligned care programs designed for the future of healthcare delivery.
          </p>
