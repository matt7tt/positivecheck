...
import { StructuredData, organizationSchema, productSchemaProviders } from "@/components/structured-data"
...
export default function ProvidersPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <StructuredData data={productSchemaProviders} />
      {/* Header */}
          ...
          <div className="flex items-center space-x-2">
            <Link href="/" className="flex items-center">
              <img
                ...
                alt="Positive Check - Healthcare provider wellness monitoring platform"
      ...
      <section className="px-6 py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="relative">
            <img
              src="/images/concerned-man-phone.webp"
              alt="Healthcare administrator reviewing patient wellness alerts on Positive Check dashboard"
              className="rounded-lg shadow-xl w-full h-80 object-cover"
            />
          </div>
          <div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <img
              ...
              alt="Medical professional using Positive Check admin console for remote patient monitoring"
