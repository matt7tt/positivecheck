            ...
            <CardContent className="p-0">
              <div className="text-center mb-8">
                <div className="flex items-center justify-center gap-3 mb-4">
                  ...
                  <h1 className="text-2xl font-bold text-gray-900">Sign In For Providers</h1>
                </div>
                <p className="text-gray-600">Access your provider dashboard and patient management tools</p>
              </div>
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-gray-600">
                  ...
                  <Link href="/providers" className="text-[#e879f9] hover:text-[#d946ef] font-medium">
                    Request a demo
                  </Link>
                </p>
              </div>
