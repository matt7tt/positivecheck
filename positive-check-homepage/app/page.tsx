    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <Card className="p-8 bg-gradient-to-br from-[#e879f9] to-[#d946ef] text-white shadow-lg">
              <CardContent className="p-0">
                ...
                <div className="mb-6">
                  <img
                    src="/happy-senior-talking-to-lola-5.webp"
                    alt="Happy senior talking on the phone"
              ...
              <CardContent className="p-0">
                ...
                <div className="mb-6">
                  <img
                    ...
                    alt="Healthcare administrator using AI system"
                    className="rounded-lg shadow-md w-full mb-6 object-cover"
                    style={{
                      height: "288px", // Set explicit height instead of h-72 class to prevent scaling issues
      ...
      <section className="px-6 py-16 bg-gradient-to-r from-purple-500 to-[#e879f9]">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="relative">
            <img
              src="/care-companion-lola-calling.webp"
              alt="Healthcare professional making wellness calls"
      ...
      <section className="px-6 py-16 bg-white">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <img
              src="/happy-senior-talking-to-lola-2.webp"
