      ...
      <main className="flex-1">
        <article className="container mx-auto px-4 py-8 max-w-4xl">
          <header className="mb-8">
            <h1 className={`${spaceGrotesk.className} text-4xl lg:text-5xl font-bold text-[#1a2642] mb-4`}>
          ...
          <div className={`${raleway.className} prose prose-lg max-w-none`}>
            ...
            <h2 className={`${spaceGrotesk.className} text-3xl font-bold text-[#1a2642] mt-8 mb-4`}>
            ...
            <div className="bg-[#f8f9ff] p-8 rounded-xl text-center my-8">
              <h3 className={`${spaceGrotesk.className} text-2xl font-bold text-[#1a2642] mb-4`}>
                Ready to Get Started?
              </h3>
              <p className="text-lg text-gray-700 mb-6">
                Experience the peace of mind that comes with daily wellness check-ins for your loved one.
              </p>
              <Link href="/onboarding-wizard">
                <Button className={`${spaceGrotesk.className} bg-[#1a2642] hover:bg-[#2a3752] text-white px-8 py-4 text-lg rounded-md`}>
